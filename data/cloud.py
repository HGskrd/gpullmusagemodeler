...
CLOUD_PRICING_CAPTURED_AT = "2026-09-21"
CLOUD_PRICING_SOURCES = {
    ...
    "xAI": "https://docs.x.ai/docs/models/grok-4-6",
    "DeepSeek": "https://api-docs.deepseek.com/quick_start/pricing/",
    "Moonshot AI": "https://platform.moonshot.ai/docs/api-reference",
...
CLOUD_MODELS = {
    "gpt-6-astra": {
        ...
        "long_context_in_per_m": 20.00,
        "long_context_cached_in_per_m": 2.00,
        "long_context_cache_write_per_m": 25.00,
        "long_context_out_per_m": 75.00,
    ...
    "gpt-5.6-sol": {
        ...
        "in_per_m": 4.00,
        "cached_in_per_m": 0.40,
        "cache_write_per_m": 5.00,
        "out_per_m": 20.00,
        "long_context_threshold_tokens": 272_000,
        "long_context_in_per_m": 8.00,
        "long_context_cached_in_per_m": 0.80,
        "long_context_cache_write_per_m": 10.00,
        "long_context_out_per_m": 30.00,
        "max_context_tokens": 1_050_000,
        "price_note": "Promotional rates published through at least 2026-11-21.",
        "quality": 0.5,
        "token_efficiency": 1.0,
    },
    "gpt-5.6-terra": {
        ...
        "long_context_cache_write_per_m": 5.00,
    ...
    "gpt-5.6-luna": {
        ...
        "long_context_cache_write_per_m": 0.50,
    ...
    "gemini-flash": {
        ...
        "cache_storage_per_m_hour": 0.50,
        "out_per_m": 3.75,
        "price_note": "Promotional rates through 2026-12-31; published 2027 rates are $1.50/$0.15/$7.50 and $1.00 per MTok-hour storage.",
        "future_pricing": {
    ...
    "gemini-3.7-flash": {
        ...
        "cache_storage_per_m_hour": 0.50,
        "out_per_m": 3.75,
        "price_note": "Promotional rates through 2026-12-31.",
        "future_pricing": {
            "effective_at": "2027-01-01",
            "in_per_m": 1.50,
            "cached_in_per_m": 0.15,
    ...
    "deepseek-v4-flash": {
        ...
        "out_per_m": 0.725,
        "peak_in_per_m": 0.30,
        "peak_cached_in_per_m": 0.006,
        "peak_out_per_m": 1.20,
        "off_peak_in_per_m": 0.15,
        "off_peak_cached_in_per_m": 0.003,
        "off_peak_out_per_m": 0.60,
        "peak_schedule_utc": (
            (0, 1, 4),
            (0, 6, 10),
            (1, 1, 4),
        ...
        "max_context_tokens": 1_000_000,
        "price_note": "Base fields are the deterministic weekly blend of 35 peak and 133 off-peak UTC hours; explicit UTC weekday/hour workload fields select the published schedule.",
        "quality": 0.5,
        "token_efficiency": 1.0,
    },
    "deepseek-v4-pro": {
        ...
        "in_per_m": 0.7975,
        "cached_in_per_m": 0.026583333333333334,
        "out_per_m": 2.3925,
        "peak_in_per_m": 1.32,
        "peak_cached_in_per_m": 0.044,
        "peak_out_per_m": 3.96,
        "off_peak_in_per_m": 0.66,
        "off_peak_cached_in_per_m": 0.022,
        "off_peak_out_per_m": 1.98,
        "peak_schedule_utc": (
            (0, 1, 4),
            (0, 6, 10),
            (1, 1, 4),
...
AA_CLOUD_METRICS: dict[str, tuple[float, float]] = {
    "gpt-6-astra": (59.0, 80.0),  # Frontier-bound proxy pending a directly comparable AA row.
    ...
    "claude-fable": (54.0, 80.0),  # Frontier-bound proxy pending a directly comparable AA row.
    ...
    "gemini-3.7-flash": (48.0, 30.0),  # Family proxy pending a direct AA row.
    "gemini-3.8-flash": (49.0, 30.0),  # Family proxy pending a direct AA row.
    ...
    "grok-4.6": (51.0, 30.0),  # Frontier-family proxy pending a direct AA row.
...
CLOUD_MODEL_ZONES: dict[str, tuple[str, ...]] = {
    ...
    "gemini-3.7-flash": _GEMINI_FLASH_ZONES,
    "gemini-3.8-flash": _GEMINI_FLASH_ZONES,
