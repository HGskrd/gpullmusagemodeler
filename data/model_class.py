...
MODEL_QUANTIZATION_PROFILES: dict[tuple[str, str], QuantizationProfile] = dict(
    [
        ...
        _artifact_profile(
            ...
            precision_key="nvfp4",
            label="NVIDIA NVFP4",
            source_repo="nvidia/Qwen3.8-27B-NVFP4",
            source_revision="dbb8f445b3145f8a4c18ddc769f032d57d32867c",
            total_weight_bytes=21_921_428_072,
            compute_precision_shares={"nvfp4": 0.78, "fp8": 0.08, "bf16": 0.14},
            quantized=("language linear weights NVFP4", "supported projections FP8"),
            retained=("vision, embeddings, norms, and excluded tensors BF16",),
            quant_algo="NVIDIA mixed NVFP4/FP8",
            group_size=16,
            notes="Exact indexed artifact footprint; compute-format shares are conservative tensor-role proxies pending full header classification.",
        ...
        _artifact_profile(
            ...
            precision_key="nvfp4",
            label="NVIDIA NVFP4",
            source_repo="nvidia/Qwen3.8-Flash-Next-NVFP4",
            source_revision="fc694b54fb0174e0913e6adf86691ef85a4ead47",
            total_weight_bytes=132_639_846_394,
            compute_precision_shares={"nvfp4": 0.68, "fp8": 0.12, "bf16": 0.20},
            quantized=(
                "main routed experts NVFP4",
                "MTP routed experts and PLE N-gram tensors FP8",
            ),
            retained=("attention, shared experts, embeddings, norms, and excluded tensors BF16",),
            quant_algo="NVIDIA mixed NVFP4/FP8",
            group_size=16,
            notes="Exact indexed artifact footprint including conditional N-gram and MTP storage; compute-format shares follow the published tensor-role policy and are not benchmark-derived.",
            captured_at="2026-09-16",
        ),
        _artifact_profile(
            ...
            precision_key="nvfp4",
            label="NVIDIA NVFP4",
            source_repo="nvidia/Muse-Glimmer-30B-NVFP4",
            source_revision="47818374517751c48c55cde2621594926b1888b6",
            total_weight_bytes=24_669_346_036,
            compute_precision_shares={"nvfp4": 0.72, "fp8": 0.08, "bf16": 0.20},
            quantized=(
                "language MLP and supported linear weights NVFP4",
                "selected projections FP8",
            ),
            retained=("vision encoder, attention-sensitive tensors, embeddings, and norms BF16",),
            quant_algo="NVIDIA mixed NVFP4/FP8",
            group_size=16,
            notes="Exact indexed artifact footprint; the mixed compute shares conservatively retain the multimodal and attention-sensitive islands.",
            captured_at="2026-09-16",
        ),
        (
        ...
        _artifact_profile(
            ...
            precision_key="nvfp4",
            label="NVIDIA NVFP4",
            source_repo="nvidia/GLM-5.3-Flash-NVFP4",
            source_revision="09b04e5e74bca08ca8549fc736d4cdd8624bfde3",
            total_weight_bytes=204_419_110_596,
            compute_precision_shares={"nvfp4": 0.78, "fp8": 0.10, "bf16": 0.12},
            quantized=(
                "MoE and supported language linear weights NVFP4",
                "selected projections FP8",
            ),
            retained=("attention, embeddings, routers, norms, and excluded tensors BF16",),
            quant_algo="NVIDIA mixed NVFP4/FP8",
            group_size=16,
            notes="Exact indexed artifact footprint; compute-format shares are conservative tensor-role proxies pending full header classification.",
            captured_at="2026-09-16",
